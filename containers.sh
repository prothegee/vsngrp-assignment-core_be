...
CONTAINER_NAMES=(
    "vsngrp-core-be-postgres-primary"
    "vsngrp-core-be-postgres-replica"
    "vsngrp-core-be-redis"
)
DATA_DIRS=(
    "containers/postgres-primary/data"
    "containers/postgres-replica/data"
...
cmd_cleanup() {
    ...
    echo "$border"
    printf '!! %-77s!!\n' "WARNING: THIS PERMANENTLY DELETES ALL DATABASE DATA FOR CORE BE"
    ...
    for dir in "${DATA_DIRS[@]}"; do
        ...
        # Container-owned files (e.g. Postgres/Redis running as their own uid under
